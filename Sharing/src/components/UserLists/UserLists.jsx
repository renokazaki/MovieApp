      ...
      {users.map((user) => (
        <div key={user.id} className="UserContainer">
          ...
          <div className="ContentList">
            <div className="top">{user.DisplayName}</div>
            <div className="bottom">
              <div className="social-media">
                <Link
                  to={`/MovieLists?category=YouTube&user=${user.DisplayName}`}
                >
                ...
                <Link
                  to={`/MovieLists?category=NETFLIX&user=${user.DisplayName}`}
                >
                ...
                <Link
                  to={`/MovieLists?category=その他&user=${user.DisplayName}`}
                >
